...
namespace Model
{
					...
					public Base::Observer
	{
		public:
			...
			void set_filter_state(FilterState a_filter_state);

			PathAlgorithm::Path get_kalman_path() const;

			PathAlgorithm::Path get_particle_path() const;
		...
		private:
			...
			PathAlgorithm::Path kalman_path;
			PathAlgorithm::Path particle_path;
