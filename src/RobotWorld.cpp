...
namespace Model
{
	...
	void RobotWorld::populate( int aNumberOfWalls /*= 2*/)
	{
		...
		*/
		...
		RobotWorld::getRobotWorld().newWall( Point(402,834), Point(323,441) ,false);
		RobotWorld::getRobotWorld().newWall( Point(820,269), Point(609,486) ,false);
		RobotWorld::getRobotWorld().newWall( Point(723,600), Point(982,1000) ,false);

		RobotWorld::getRobotWorld().newWall( Point(0,0), Point(0,1024) ,false);
		RobotWorld::getRobotWorld().newWall( Point(0,0), Point(1024,0) ,false);
		RobotWorld::getRobotWorld().newWall( Point(0,1024), Point(1024,1024) ,false);
		RobotWorld::getRobotWorld().newWall( Point(1024,0), Point(1024,1024) ,false);
